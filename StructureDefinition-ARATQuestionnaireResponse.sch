...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:QuestionnaireResponse/f:item/f:item">
      ...
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://example.org/StructureDefinition/test-time-extension']) &lt;= 1">extension with URL = 'http://example.org/StructureDefinition/test-time-extension': maximum cardinality of 'extension' is 1</sch:assert>
